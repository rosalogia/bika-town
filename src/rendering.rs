...
impl SpriteSheet {
    ...
    pub fn draw_to(&self, i: usize, x: i32, y: i32, texture: &Texture, canvas: &mut WindowCanvas) {
    ...
    pub fn draw_animated(&mut self, x: i32, y: i32, texture: &Texture, canvas: &mut WindowCanvas) {
        self.draw_to(
